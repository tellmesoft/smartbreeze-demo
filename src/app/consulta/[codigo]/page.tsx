      ...
      <div className="mx-auto max-w-lg space-y-6 px-4 py-6 pb-[max(1.5rem,env(safe-area-inset-bottom))] sm:px-6">
        ...
        <Card className="overflow-hidden border-gray-200 shadow-sm">
          <details className="group" open>
            <summary className="flex cursor-pointer list-none items-center justify-between gap-3 border-b border-gray-100 bg-white px-6 py-4 marker:content-none">
            ...
            {!sessionUser ? (
              <PendingNavButton href="/login" className="h-11 w-full" loadingText="Abriendo...">
                Ingresar al sistema
              </PendingNavButton>
            ) : (
              <PendingNavButton
